...
create table usuarios_agregan_amigos (id_usuario_agrega_amigos int primary key auto_increment, id_usuario int, id_amigo int, foreign key (id_usuario) REFERENCES usuario (id_usuario), foreign key (id_amigo) REFERENCES usuario(id_usuario));

create table usuarios_pertenecen_a_grupos (id_usuario_grupo int primary key auto_increment, id_grupo int, id_usuario int, foreign key (id_grupo) REFERENCES grupos (id_grupo), foreign key (id_usuario) REFERENCES usuario (id_usuario));
